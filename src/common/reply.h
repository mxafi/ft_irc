...
#define RPL_ERR_TOOMANYTARGETS_407(servername) (RPL_META_MESSAGE(servername, "407", + " :407 Too many recipients."))
#define RPL_ERR_NORECIPIENT_411(servername, command) (RPL_META_MESSAGE(servername, "411", + " :No recipient given (" + command + ")"))
#define RPL_ERR_NOTEXTTOSEND_412(servername) (RPL_META_MESSAGE(servername, "412", + " :No test to send"))
